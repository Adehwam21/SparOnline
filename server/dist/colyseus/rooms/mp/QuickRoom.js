...
*/
class QuickRoom extends colyseus_1.Room {
    constructor() {
        super(...arguments);
        this.MAX_CLIENTS = 4;
        this.MAX_MOVES = 5;
    ...
    onCreate(options) {
        ...
        this.setMetadata({
            ...
            isLocked: (_b = options.isLocked) !== null && _b !== void 0 ? _b : false,
            isPrivate: (_c = options.isPrivate) !== null && _c !== void 0 ? _c : false,
        });
