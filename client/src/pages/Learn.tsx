...
const LearnPage: React.FC = () => {
  return (
    <>
    <div className="h-full flex flex-col justify-center items-center bg-transparent text-white">
      <Header />
      <div className="max-w-3xl pt-30 p-8 ">
        ...
        <p className="mb-2">A deck of <span className="text-yellow-400 font-bold">32</span> cards made up of ranks <span className="text-yellow-400 font-bold">6 – King</span></p>
