...
const LearnPage: React.FC = () => {
  return (
    <div className=" min-h-screen flex flex-col p-6 text-black">
      <div className="max-w-3xl pt-15">
        ...
        <h2 className="text-2xl font-bold text-green-900 mt-6 mb-2">Game Setup</h2>
        ...
        <h2 className="text-2xl font-bold text-green-900 mt-6 mb-2">Gameplay</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold text-green-900 mt-6 mb-2">Scoring System</h2>
        <p className="mb-2">
        ...
        <h2 className="text-2xl font-bold text-green-900 mt-6 mb-2">Ready to Play?</h2>
        <p className="mb-6">Gather your friends and try out SparOnline now!</p>

        <button className="bg-yellow-500 text-gray-900 px-6 py-2 rounded-lg font-bold hover:bg-yellow-400 transition-all duration-200">
          Start Playing
        </button>
      </div>
    </div>
